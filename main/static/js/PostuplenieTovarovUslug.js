$( document ).ready(function() {
    ...
    $("#TipTSen").on( "click", function() {
        window.open("/TipyTSenNomenklaturyKontragentov/new/");
    });
    ...
    $( "#id_SkladOrderSklady" ).closest( "p" ).append( '<button id="Sklad">+</button>' );
    ...
    $("#BankovskiySchetKontragenta").on( "click", function() {
        window.open("/BankovskieScheta/new/");
    });

    $("#ZakazPokupatelya").on( "click", function() {
        window.open("/ZakazPokupatelya/new/");
    });

    $("#StatiyaZatrat").on( "click", function() {
